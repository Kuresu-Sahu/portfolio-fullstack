        ...
        const fetchUser = async () => {
            try {
                const { data } = await axios.get(
                    "https://portfolio-fullstack-nhdz.onrender.com/api/v1/user/portfolio/me"
                );
                setUser(data.user);
            } catch (error) {
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-6 z-10 w-full flex flex-col-reverse md:flex-row items-center justify-between gap-12">
                ...
                <div className="w-full md:w-1/2 text-center md:text-left">
                    ...
                    >
                        <SocialIcon href="https://github.com/Kuresu-Sahu" icon={<Github size={22} />} color="hover:text-white hover:shadow-[0_0_15px_white]" />
                        <SocialIcon href="https://www.linkedin.com/in/kuresu-sahu/" icon={<Linkedin size={22} />} color="hover:text-blue-500 hover:shadow-[0_0_15px_#3b82f6]" />
                        <SocialIcon href="https://www.instagram.com/innocent._.chandan/" icon={<Instagram size={22} />} color="hover:text-pink-500 hover:shadow-[0_0_15px_#ec4899]" />
                        <SocialIcon href="https://x.com/Kuresu_Sahu" icon={<Twitter size={22} />} color="hover:text-blue-400 hover:shadow-[0_0_15px_#60a5fa]" />
                    </motion.div>
                    ...
                    >
                        ...
                        <a
                            ...
                            download="Kuresu_Sahu_Resume.pdf" // Force Download with Name
                            target="_blank"
