  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "https://portfolio-fullstack-nhdz.onrender.com/api/v1/message/send",
      ...
      <div className="max-w-6xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        >
          ...
          <div className="space-y-6">
            {/* Glassy Icon Boxes */}
            <ContactInfoBox icon={<Mail />} text="kuresusahu18@gmail.com" color="text-blue-400" bgColor="bg-blue-500/10" borderColor="border-blue-500/20" />
            <ContactInfoBox icon={<Phone />} text="+91 7008903717" color="text-purple-400" bgColor="bg-purple-500/10" borderColor="border-purple-500/20" />
            <ContactInfoBox icon={<MapPin />} text="Bangalore, India" color="text-pink-400" bgColor="bg-pink-500/10" borderColor="border-pink-500/20" />
          </div>
        </motion.div>
