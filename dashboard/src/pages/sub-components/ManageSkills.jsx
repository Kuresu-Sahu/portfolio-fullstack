  ...
  const fetchSkills = async () => {
    try {
      const { data } = await axios.get(
        "https://portfolio-fullstack-nhdz.onrender.com/api/v1/softwareapplication/getall",
  ...
  const handleUpdate = async (id) => {
    ...
    try {
      const { data } = await axios.put(
        `https://portfolio-fullstack-nhdz.onrender.com/api/v1/softwareapplication/update/${id}`,
        formData,
  ...
  const handleDelete = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://portfolio-fullstack-nhdz.onrender.com/api/v1/softwareapplication/delete/${id}`,
        { withCredentials: true }
      );
      toast.success(data.message);
