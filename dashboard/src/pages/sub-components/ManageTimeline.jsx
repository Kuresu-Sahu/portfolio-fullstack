  ...
  const fetchTimelines = async () => {
    try {
      ...
      const { data } = await axios.get(
        "https://portfolio-fullstack-nhdz.onrender.com/api/v1/timeline/getall",
  ...
  const handleUpdate = async (id) => {
    try {
      const { data } = await axios.put(
        `https://portfolio-fullstack-nhdz.onrender.com/api/v1/timeline/update/${id}`,
  ...
  const handleDelete = async (id) => {
    try {
      const { data } = await axios.delete(
        `https://portfolio-fullstack-nhdz.onrender.com/api/v1/timeline/delete/${id}`,
        { withCredentials: true }
      );
      toast.success(data.message);
